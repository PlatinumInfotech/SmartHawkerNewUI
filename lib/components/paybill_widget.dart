...
import 'paybill_model.dart';
export 'paybill_model.dart';
...
class _PaybillWidgetState extends State<PaybillWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaybillModel());
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent('PAYBILL_COMP_PAY_NOW_BTN_ON_TAP');
