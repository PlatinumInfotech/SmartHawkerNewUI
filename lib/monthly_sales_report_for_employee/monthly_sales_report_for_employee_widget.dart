...
import 'monthly_sales_report_for_employee_model.dart';
export 'monthly_sales_report_for_employee_model.dart';
...
/// shows in this.
class MonthlySalesReportForEmployeeWidget extends StatefulWidget {
  const MonthlySalesReportForEmployeeWidget({
    super.key,
  ...
  static String routeName = 'MonthlySalesReportForEmployee';
  static String routePath = '/monthlySalesReportForEmployee';

  @override
  State<MonthlySalesReportForEmployeeWidget> createState() =>
      _MonthlySalesReportForEmployeeWidgetState();
}

class _MonthlySalesReportForEmployeeWidgetState
    extends State<MonthlySalesReportForEmployeeWidget> {
  late MonthlySalesReportForEmployeeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MonthlySalesReportForEmployeeModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MonthlySalesReportForEmployee'});
  }
          ...
          title: Row(
            ...
            children: [
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('MONTHLY_SALES_REPORT_FOR_EMPLOYEE_arrow_');
              ...
              Expanded(
                child: Align(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'MONTHLY_SALES_REPORT_FOR_EMPLOYEE_Icon_2');
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'MONTHLY_SALES_REPORT_FOR_EMPLOYEE_GENERA');
                                                                                              ...
                                                                                              children: [
                                                                                                ...
                                                                                                FlutterFlowIconButton(
                                                                                                  ...
                                                                                                  onPressed: ('${getJsonField(
                                                                                                      ...
                                                                                                      ? null
                                                                                                      : () async {
                                                                                                          logFirebaseEvent('MONTHLY_SALES_REPORT_FOR_EMPLOYEE_edit_I');
                                                                                                          logFirebaseEvent('IconButton_navigate_to');

                                                                                                          context.pushNamed(
                                                                                                            EProductSaleEditWidget.routeName,
                                                                                                            queryParameters: {
                                                                                                ...
                                                                                                FlutterFlowIconButton(
                                                                                                  ...
                                                                                                  onPressed: ('${getJsonField(
                                                                                                      ...
                                                                                                      ? null
                                                                                                      : () async {
                                                                                                          logFirebaseEvent('MONTHLY_SALES_REPORT_FOR_EMPLOYEE_delete');
                                                                                                          ...
                                                                                                          if (confirmDialogResponse) {
                                                                                                            ...
                                                                                                            _model.apiResults7nCopy = await SmartHawkerAPIsGroup.salesDeleteByVendorAPICall.call(
                                                                                                              authToken: FFAppState().AuthenticationToken,
                                                                                                              saleId: getJsonField(
                                                                                                                salesData2Item,
                                                                                                                r'''$.sale_id''',
                                                                                                            ...
                                                                                                            if ((_model.apiResults7nCopy?.succeeded ?? true)) {
                                                                                                              logFirebaseEvent('IconButton_alert_dialog');
                                                                                                              await showDialog(
                                                                                                                context: context,
                                                                                                                builder: (alertDialogContext) {
                                        ...
                                        Expanded(
                                          child: FutureBuilder<ApiCallResponse>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              final listViewMonthlySummaryAPIResponse =
                                                  snapshot.data!;
                                                ...
                                                children: [
                                                  Align(
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        getJsonField(
                                                          listViewMonthlySummaryAPIResponse
                                                              .jsonBody,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '4udh3oqq' /* No data available for selected... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
