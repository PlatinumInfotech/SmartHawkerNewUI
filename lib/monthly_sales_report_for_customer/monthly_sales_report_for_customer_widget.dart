...
import 'monthly_sales_report_for_customer_model.dart';
export 'monthly_sales_report_for_customer_model.dart';
...
/// shows in this.
class MonthlySalesReportForCustomerWidget extends StatefulWidget {
  const MonthlySalesReportForCustomerWidget({
    super.key,
  ...
  static String routeName = 'MonthlySalesReportForCustomer';
  static String routePath = '/monthlySalesReportForCustomer';

  @override
  State<MonthlySalesReportForCustomerWidget> createState() =>
      _MonthlySalesReportForCustomerWidgetState();
}

class _MonthlySalesReportForCustomerWidgetState
    extends State<MonthlySalesReportForCustomerWidget> {
  late MonthlySalesReportForCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MonthlySalesReportForCustomerModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'MonthlySalesReportForCustomer'});
  }
          ...
          title: Row(
            ...
            children: [
              FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('MONTHLY_SALES_REPORT_FOR_CUSTOMER_arrow_');
              ...
              Expanded(
                child: Align(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'MONTHLY_SALES_REPORT_FOR_CUSTOMER_Icon_s');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            FFButtonWidget(
                              onPressed: () async {
                                logFirebaseEvent(
                                    'MONTHLY_SALES_REPORT_FOR_CUSTOMER_GENERA');
                                logFirebaseEvent('Button_backend_call');
                                _model.apiResultzmx = await SmartHawkerAPIsGroup
                                ...
                                if ((_model.apiResultzmx?.succeeded ?? true)) {
                                ...
                                Container(
                                  ...
                                  child: Align(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'MONTHLY_SALES_REPORT_FOR_CUSTOMER_Text_t');
                                        logFirebaseEvent('Text_navigate_to');

                                        context.pushNamed(
                                          PaymentQRWidget.routeName,
                                          queryParameters: {
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '405ynavm' /* No data available for selected... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
