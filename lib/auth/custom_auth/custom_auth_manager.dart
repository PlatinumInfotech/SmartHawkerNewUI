...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    smartHawkerLatestAuthUserSubject.add(
      SmartHawkerLatestAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SmartHawkerLatestAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SmartHawkerLatestAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SmartHawkerLatestAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    smartHawkerLatestAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SmartHawkerLatestAuthUser? currentUser;
