...
import 'e_page_model.dart';
export 'e_page_model.dart';
...
class EPageWidget extends StatefulWidget {
  const EPageWidget({
    super.key,
  ...
  static String routeName = 'EPage';
  static String routePath = '/ePage';

  @override
  State<EPageWidget> createState() => _EPageWidgetState();
}

class _EPageWidgetState extends State<EPageWidget> {
  late EPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EPageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EPage'});
  }
        ...
        appBar: AppBar(
          ...
          actions: [
            FlutterFlowIconButton(
              ...
              onPressed: () async {
                logFirebaseEvent('E_PAGE_PAGE_logout_ICN_ON_TAP');
                                      ...
                                      itemBuilder:
                                        ...
                                        return Padding(
                                          ...
                                          child: InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'E_PAGE_PAGE_Row_ycxkbay9_ON_TAP');
                                              logFirebaseEvent(
                                                  'Row_navigate_to');

                                              context.pushNamed(
                                                EGetCustomerWidget.routeName,
                                                queryParameters: {
                                                  ...
                                                  children: [
                                                    ...
                                                    Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'k3z5axu8' /* Connected business partners */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
